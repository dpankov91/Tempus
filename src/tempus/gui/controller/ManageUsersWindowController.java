...
public class ManageUsersWindowController implements Initializable {
    ...
    private void writeToDatabase(TableColumn.CellEditEvent<User, String> event) {
        ...
        switch (event.getTableColumn().getText()) {
            case "First Name":
                userModel.editUser(us.getId(), assignedValue, us.getLName(), us.getEmail(), us.getPhone(), us.getPostcode(), us.getAddress(),us.getPhotoURL().getUrl(),us.getPassword());
                us.setfName(assignedValue);
                break;
            case "Last Name":
                userModel.editUser(us.getId(), us.getFName(), assignedValue, us.getEmail(), us.getPhone(), us.getPostcode(), us.getAddress(),us.getPhotoURL().getUrl(),us.getPassword());
            ...
            case "Role":
                ...
                break;
            case "E-Mail":
                userModel.editUser(us.getId(), us.getFName(), us.getLName(), assignedValue, us.getPhone(), us.getPostcode(), us.getAddress(),us.getPhotoURL().getUrl(),us.getPassword());
                us.setEmail(assignedValue);
                break;
            case "Address":
                userModel.editUser(us.getId(), us.getFName(), us.getLName(), us.getEmail(), us.getPhone(), us.getPostcode(), assignedValue,us.getPhotoURL().getUrl(),us.getPassword());
    ...
    private void writeToDatabaseNumber(TableColumn.CellEditEvent<User, Integer> event) {
        ...
        switch (event.getTableColumn().getText()) {
            case "Phone":
                userModel.editUser(us.getId(), us.getFName(), us.getLName(), us.getEmail(), assignedValue, us.getPostcode(), us.getAddress(),us.getPhotoURL().getUrl(),us.getPassword());
                us.setPhone(assignedValue);
                break;
            case "Postcode":
                userModel.editUser(us.getId(), us.getFName(), us.getLName(), us.getEmail(), us.getPhone(), assignedValue, us.getAddress(),us.getPhotoURL().getUrl(),us.getPassword());
